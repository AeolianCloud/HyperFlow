        ...
        "/nodes/{node}/vms": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "创建参数（vmid、cores、memory、diskSource、storage 为必填；name 为可选，不填时自动生成随机主机名；CloudInit 字段均为可选；ciPackages 非空时 snippetsStorage 必填）",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "pve.CreateVmRequest": {
            ...
            "properties": {
                ...
                "autoAssignIp": {
                    "description": "是否自动分配 IP（ipPoolId 非空且未指定 ipAddress 时默认为 true）",
                    "type": "boolean",
                    "example": true
                },
                "ciPackages": {
                ...
                "ipAddress": {
                    "description": "指定分配的 IP 地址（可选，不指定时随机分配）",
                    "type": "string",
                    "example": "10.0.0.10"
                },
                "ipConfig0": {
                ...
                "ipPoolId": {
                    "description": "IP 池配置（可选，使用 IP 池时自动分配地址并填充 CloudInit 参数）",
                    "type": "string",
                    "example": "pool-abc123"
                },
                "memory": {
